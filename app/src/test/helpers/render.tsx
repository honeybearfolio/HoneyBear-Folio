...
const DEFAULT_TAURI_RESPONSES: Record<string, unknown> = {
  compute_net_worth: 0,
 ...
 */
export function mockNumberFormat(
  overrides: NumberFormatMockState = {},
): void {
...
export function mockTauri(
  ...
  vi.mocked(invoke).mockImplementation((cmd: string, args?: unknown) => {
    ...
    if (typeof entry === "function") return Promise.resolve(entry(args));
